...
function app() {
  return {
    ...
    appVersion: '1.0.5',
    updateInfo: { checking: false, updating: false, checked: false, available: false, status: 'idle', progress: 0, current: '1.0.5', latest: '', asset_size: 0, downloaded_bytes: 0, resumed: false, message: '', error: '' },
